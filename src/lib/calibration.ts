/**
 * Official IELTS calibration set.
 *
 * Source: "Sample Candidate Writing Responses and Examiner Comments", published
 * by IELTS at ielts.org (Academic sample test questions → Academic Writing).
 * The essays and the bands are the real thing — marked by certificated IELTS
 * examiners — which makes them the only ground truth available for free.
 *
 * Used to answer one question: does this tool inflate? Run `npm run calibrate`.
...
export const CALIBRATION_SET: CalibrationCase[] = [
  {
    ...
    body: `I completly disagree with the written statment. I believe that most of the people in the world have more information about their health and also about how they can improve their healthy conditions.
...
Another important issue that I would like to mention is how medicine is changing. There are new discovers and treatments almost every week and that is an inequivoque sintom of how things are changing in order to improve the world's health.`,
  },
  {
    ...
    body: `Recently, there have been a lot of discussions about health and whether it is going to improve or not. In my opinion, I think that people will become unhealthier in the future than they are now.
